...
const class11Data: CourseData = {
    ...
    description: "AAKRITI for Class XI is designed to introduce students to structured learning while nurturing curiosity and conceptual understanding. The course focuses on building strong fundamentals in core subjects, preparing students for higher academic challenges.",
    forWho: {
        newStarters: "Students entering Class XI looking for a head start.",
...
export default function CourseClasses() {
    return <CourseDetails data={class11Data} />;
}
