                ...
                <div className="bg-gradient-to-r from-blue-600 to-sky-400 rounded-3xl p-8 text-white relative overflow-hidden">
                    <div className="relative z-10 max-w-2xl">
                        ...
                        <div className="mt-6 flex items-center gap-4">
                            <Link href="/student/dashboard/courses" className="px-6 py-2.5 bg-white text-blue-600 rounded-xl font-semibold hover:bg-blue-50 transition-colors">
                                Resume Learning
                            </Link>
                    ...
                    <AnimatedContent delay={0.5} distance={20}>
                        <div className="bg-white rounded-3xl border border-gray-100 p-6">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <Link href="/student/dashboard/live" className="text-sm font-semibold text-blue-600 flex items-center gap-1 hover:gap-2 transition-all">
                                    ...
                                    <div key={i} className="flex items-center justify-between p-4 rounded-2xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100 group">
                                        <div className="flex items-center gap-4">
                                            <div className={cn(
                                                ...
                                                item.status === "in-progress" ? "bg-yellow-50 text-yellow-600" : "bg-gray-50 text-gray-400"
                                            )}>
                ...
                <div className="space-y-8">
                        ...
                        <div className="bg-white rounded-3xl border border-gray-100 p-6 h-full">
                            ...
                            <div className="space-y-6">
                                {[
                                    ...
                                    { subject: "Physics", progress: 72, color: "bg-yellow-500" },
                                    { subject: "Chemistry", progress: 94, color: "bg-sky-400" },
                                    { subject: "Biology", progress: 68, color: "bg-gray-500" }
                                ].map((subject, i) => (
                            ...
                            <div className="mt-10 p-4 bg-yellow-50 rounded-2xl">
                    ...
                    <AnimatedContent delay={0.8} distance={20}>
                        <div className="bg-white rounded-3xl border border-gray-100 p-6">
                            ...
                            <div className="space-y-4">
                                {[
                                    { name: "JEE Mock #14", color: "bg-yellow-100" },
